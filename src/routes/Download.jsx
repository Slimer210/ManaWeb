  ...
  return (
    <div className="m-12">
      <div className="flex flex-col mt-24 flex-1 items-center justify-center min-h-[82vh] max-h-fit">
        ...
        <div className="flex flex-col justify-center items-center relative z-10 gap-y-8">
          ...
          <p className="flex font-body text-center justify-center text-2xl tracking-widest w-screen">
            官方推薦直使用最新版本遊玩，以獲得最佳遊戲體驗。
            <br />
            欲體驗舊版本的內容，往下滑可查看所有舊版本的更新日誌及下載鏈接。
          </p>
          <div className="p-8 items-center flex flex-col tablet:flex-row">
            <Link to="/" className="text-white bg-mana-purple m-8 px-12 py-8 rounded-xl text-[2.5rem] border-4 border-solid border-mana-purple self-center whitespace-nowrap">
              下载自动安装器
            </Link>
            <Link to="/" className="text-mana-purple bg-slate-50 m-8 px-12 py-8 rounded-xl text-[2.5rem] border-4 border-solid border-mana-purple self-center whitespace-nowrap">
              手动安装
            </Link>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="table border-black border-collapse table-auto w-full my-3 rounded-lg">
          <tr className="bg-mana-purple text-white content-start">
            ...
            <th className="py-4 text-[1.5rem] font-sans">更新日志</th>
          ...
          {version5x.map((data) => (
            <tr>
              {[
                ...
                <td className="px-4 py-4 text-[1.5rem] font-serif border-2 border-slate-100">{item}</td>
              ))}
              {[
                data.releaseDate,
              ].map((item) => (
                <td className="px-4 py-4 text-[1.5rem] font-serif border-2 border-slate-100">
              ...
              {[
                ...
                <td className="px-4 py-4 text-[1.5rem] font-body border-2 border-slate-100">
                  <a href={item} className="text-mana-purple font-body">查看</a>
                </td>
              ))}
              {[
                data.downloadLink,
                ...
                <td className="px-4 py-4 text-[1.5rem] font-body border-2 border-slate-100">
                  <a href={item} className="text-mana-purple font-body">下载</a>
                </td>
              ))}
            </tr>
          ))}
